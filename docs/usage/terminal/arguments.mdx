...
Specifies which language model to use. Check out the [models](https://docs.testdriver.ai/language-model-setup/introduction) section for a list of available models.
...
Inform TestDriver that the language model you're using supports vision.
