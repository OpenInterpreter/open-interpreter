...
>
  Learn how to build TestDriver into your application.
</Card>
...
Setting this flag to `True` allows TestDriver to automatically run the generated code without user confirmation.
