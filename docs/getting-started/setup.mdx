...
These installers will attempt to download Python, set up an environment, and install TestDriver for you.
...
If you already use Python, we recommend installing TestDriver via `pip`:
