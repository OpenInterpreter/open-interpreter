...
## Running your locally modified version

To run your local changes with [Poetry](https://python-poetry.org/docs/#installing-with-the-official-installer), follow these steps:
...
This command installs your project along with its dependencies in a virtual environment managed by Poetry.

Run your local version of Open Interpreter with:

```bash
poetry run interpreter
```

This ensures Open Interpreter runs within the Poetry-created virtual environment, using the correct dependencies and your local changes.
