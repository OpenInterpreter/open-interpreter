...
If you already use Python, you can open your terminal [(click here to learn how)](https://chat.openai.com/share/ce4a2266-6901-4d1a-ada6-de1f2b17873b) then paste the following text:
...
If that doesn't work, please try one of our [one-line installers](/getting-started/setup).