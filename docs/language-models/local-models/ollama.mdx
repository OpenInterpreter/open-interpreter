...
4. It will likely take a while to download, but once it does, we are ready to use it with TestDriver. You can either run `interpreter --local` to set it up interactively in the terminal, or do it manually:
