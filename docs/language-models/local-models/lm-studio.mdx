...
TestDriver can use OpenAI-compatible server to run models locally. (LM Studio, jan.ai, ollama etc)
...
Once the server is running, you can begin your conversation with TestDriver.
