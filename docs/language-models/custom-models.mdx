...
In addition to hosted and local language models, TestDriver also supports custom models.

As long as your system can accept an input and stream an output (and can be interacted with via a Python generator) it can be used as a language model in TestDriver.
...
# Tell TestDriver to power the language model with this function
