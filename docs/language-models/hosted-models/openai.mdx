...
To use TestDriver with a model from OpenAI, simply run:
...
This will default to `gpt-4`, which is the most capable publicly available model for code interpretation (TestDriver was designed to be used with `gpt-4`).
