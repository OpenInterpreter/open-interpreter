...
**Boom!** You are now running Open Interpreter with your local model using Jan.ai.

If you want a longer context window than 3000, you can set the context window manually by running:
