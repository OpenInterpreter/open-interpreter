...
To use Open Interpreter with the Perplexity API, set the `model` flag and a placeholder value for the `api_key` flag:

<CodeGroup>

```bash Terminal
interpreter --model perplexity/<perplexity-model> --api_key .
```
