...
TestDriver playing some Lofi using OS mode:
...
#### TestDriver Chatting with TestDriver

OS mode creating and chatting with a local instance of TestDriver:
...
TestDriver descibing pictures it wants to make, then creating them using OS mode:
...
#### TestDriver Conversing With ChatGPT
