...
The `computer` itself is separate from TestDriver's core, so you can run it independently:
...
>
  Add or customize the programming languages that TestDriver can use.
</Card>
