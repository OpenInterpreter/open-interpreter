...
The following functions are designed for language models to use in TestDriver, currently only supported in [OS Mode](/guides/os-mode/).
...
```python
interpreter.computer.sms.send("2068675309", "Hello from TestDriver!")
```
