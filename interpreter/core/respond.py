...
from tokentrim import trim as tt
...
def respond(interpreter):
    ...
    while True:
        ...
        messages = tt.trim(interpreter.messages)
        ...
        for chunk in interpreter._llm(messages):
        ...
        if "code" in interpreter.messages[-1]:
            ...
            if language not in interpreter._code_interpreters:
                interpreter.code_interpreters[language] = create_code_interpreter(language)
