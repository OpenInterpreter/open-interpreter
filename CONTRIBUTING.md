...
We are developing a public roadmap to provide visibility into our priorities and upcoming enhancements.
...
- **Bug Reports:** Include detailed steps to reproduce the issue and specifics about your operating system and Python version, with screenshots and code/error snippets if required.
- **Feature Requests:** Explain how your idea benefits Open Interpreter and its community.

## Contributing Code

We welcome code contributions through pull requests. Here are some guidelines:

- Before making significant code changes, please discuss your ideas on [Discord] to ensure they align with our project vision. We want to keep the codebase simple and unintimidating for new users.
...
After modifying the source code, you must do `poetry run interpreter` again.
